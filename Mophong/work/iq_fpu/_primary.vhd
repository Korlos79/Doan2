...
entity iq_fpu is
    ...
    port(
        ...
        wr_prs3_data    : in     vl_logic_vector(31 downto 0);
        wr_prs3         : in     vl_logic_vector;
        wr_prs3_ready   : in     vl_logic;
        wr_fpu_op       : in     vl_logic_vector(4 downto 0);
        wr_rob_idx      : in     vl_logic_vector;
        wr_fp_rd        : in     vl_logic;
        wr_fp_rs1       : in     vl_logic;
        ...
        issue_rs3_val   : out    vl_logic_vector(31 downto 0);
        issue_fpu_op    : out    vl_logic_vector(4 downto 0);
        issue_fp_rd     : out    vl_logic;
        issue_fp_rs1    : out    vl_logic;
