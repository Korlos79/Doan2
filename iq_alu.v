...
module iq_alu #(
    ...
    input  wire [31:0]           wr_prs1_data,  // giá trị thực khi ready tại dispatch
    ...
    // =========================================================================
    // Issue selection (oldest-first)  ← phải khai báo TRƯỚC free_slot
    // [FIX-AGE-TIE] dùng rob_idx làm tiebreaker khi age bằng nhau
    // =========================================================================
    integer si;
    ...
    // [FIX-IQ-CONFLICT] skip issue_slot khi found_issue=1 để tránh
    // free_slot == issue_slot trong cùng always block → entry bị overwrite
    // =========================================================================
    integer fi;
    ...
    always @(posedge clk or negedge rst_n) begin
        if (!rst_n) begin
            ...
            if (wr_en && !full) begin
                ...
                // [FIX] Same-cycle CDB snoop at write: nếu CDB arrive cùng cycle
                // với dispatch, entry mới phải được đánh dấu ready ngay tránh miss
